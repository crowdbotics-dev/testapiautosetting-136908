...
class Testconnectors136908ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS136908_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS136908_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS136908"
