"""
Django settings for testapiautosetting_136908 project.
...
ROOT_URLCONF = "testapiautosetting_136908.urls"
...
WSGI_APPLICATION = "testapiautosetting_136908.wsgi.application"
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL",
    "TestAPIAutoSettingsvrp49 Support <support@testapiautosetting-136908.botics.co>",
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapiautosetting_136908 API",
    "DESCRIPTION": "API documentation for testapiautosetting_136908 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = (
        "testapiautosetting_136908.storage_backends.AzureMediaStorage"
    )
    STATICFILES_STORAGE = (
        "testapiautosetting_136908.storage_backends.AzureStaticStorage"
    )

DEFAULT_AUTO_FIELD = "django.db.models.AutoField"
CONNECTOR_TESTCONNECTORS136908_USERNAME = env.str(
    "CONNECTOR_TESTCONNECTORS136908_USERNAME", ""
)
CONNECTOR_TESTCONNECTORS136908_PASSWORD = env.str(
    "CONNECTOR_TESTCONNECTORS136908_PASSWORD", ""
)
